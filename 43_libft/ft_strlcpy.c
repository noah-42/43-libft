...
/*
	...
	_Parameter(s)_
		The 'size' parameter is the size of the `dst` string.
...
/*
+---------+---------+----------+-----------+--------+------------------------+
| Example |   src   | dst size | dst after | return |       Truncated?       |
+---------+---------+----------+-----------+--------+------------------------+
|    1    | "hello" |    20    |  "hello"  |   5    |          No            |
+---------+---------+----------+-----------+--------+------------------------+
|    2    | "hello" |     4    |   "hel"   |   5    |   Yes (5 >= 4)         |
+---------+---------+----------+-----------+--------+------------------------+
|    3    | "hello" |     0    | unchanged |   5    | Yes (nothing written)  |
+---------+---------+----------+-----------+--------+------------------------+
|    4    | "hello" |     1    |    ""     |   5    |   Yes (null only)      |
+---------+---------+----------+-----------+--------+------------------------+
|    5    |    ""   |    10    |    ""     |   0    |          No            |
+---------+---------+----------+-----------+--------+------------------------+
|    6    | "hello" |     6    |  "hello"  |   5    |   No (exact fit)       |
+---------+---------+----------+-----------+--------+------------------------+
*/
